...
final class Preconditions {
     ...
     * @since 20.0 (varargs overload since 2.0)
     */
    static void checkState(boolean b, String errorMessageTemplate, char p1, char p2) {
        if (!b) {
     ...
     * @since 20.0 (varargs overload since 2.0)
     */
    static void checkState(boolean b, String errorMessageTemplate, char p1, long p2) {
        if (!b) {
            throw new IllegalStateException(lenientFormat(errorMessageTemplate, p1, p2));
        }
    }
     ...
     * @since 20.0 (varargs overload since 2.0)
     */
    static void checkState(boolean b, String errorMessageTemplate, long p1, char p2) {
        if (!b) {
            throw new IllegalStateException(lenientFormat(errorMessageTemplate, p1, p2));
        }
    }
     ...
     * @since 20.0 (varargs overload since 2.0)
     */
    static void checkState(boolean b, String errorMessageTemplate, long p1, long p2) {
        if (!b) {
            throw new IllegalStateException(lenientFormat(errorMessageTemplate, p1, p2));
        }
    }
